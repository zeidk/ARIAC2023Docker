...
# Start the container
# docker run -d --name $teamName -p 6081:80 --shm-size=512m jfernandez37/ariac:ariac_latest
docker run -d --name $teamName -p 6081:80 --shm-size=512m ariac2023_1.4:latest
